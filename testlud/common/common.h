...
/*
void 
write_input_maxrix_to_file(float arr[4][4], int dim,  const char* filename);

void
write_weight_maxrix_to_file(float arr[4][4], int dim,  const char* filename);
*/

int
read_tmp_from_file(const char *filename);
