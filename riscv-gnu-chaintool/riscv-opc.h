...
#define MATCH_ROCC 0x2b
#define MASK_ROCC  0xfe00707f

#define MATCH_GEMM 0x4001033
#define MASK_GEMM  0xfe00707f
#define MATCH_ILOAD 0x6001033
#define MASK_ILOAD  0xfe00707f
#define MATCH_WLOAD 0x8001033
#define MASK_WLOAD  0xfe00707f
#define MATCH_CONV 0xc001033
#define MASK_CONV  0xfe00707f
#define MATCH_INIT_CONV 0xe001033
#define MASK_INIT_CONV  0xfe00707f
#define MATCH_MAXPOOL 0x10001033
#define MASK_MAXPOOL  0xfe00707f
...
DECLARE_INSN(gemm, MATCH_GEMM, MASK_GEMM)
DECLARE_INSN(iload, MATCH_ILOAD, MASK_ILOAD)
DECLARE_INSN(wload, MATCH_WLOAD, MASK_WLOAD)
DECLARE_INSN(conv, MATCH_CONV, MASK_CONV)
DECLARE_INSN(init_conv, MATCH_INIT_CONV, MASK_INIT_CONV)
DECLARE_INSN(maxpool, MATCH_MAXPOOL, MASK_MAXPOOL)


DECLARE_INSN(rocc, MATCH_ROCC, MASK_ROCC)
