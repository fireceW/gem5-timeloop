...
def modify_data_dict(dic, params):
    dic['problem']['instance']['C'] = params[0]
    dic['problem']['instance']['M'] = params[2]
    dic['problem']['instance']['P'] = params[1]
    dic['problem']['instance']['Q'] = params[1]
    dic['problem']['instance']['R'] = params[4]
    dic['problem']['instance']['S'] = params[4]
...
def generate_new_yaml():
    ...
    new_yaml_file = "/home/yangnan/gtloopg/gtimeloop/prob/conv.yaml"
